...
2. หา drawer **Menu Organizer** แล้วกด **Arrange Extensions**
3. คอมพิวเตอร์แสดงสองคอลัมน์ (ซ้าย/ขวา) มือถือแสดงรายการเดียว
4. กด **↑ / ↓** เพื่อจัดลำดับ บนคอมกด **⇄** เพื่อย้ายคอลัมน์ หรือลากด้วยไอคอน ⠿ ได้
...
- บนมือถือ: ใช้ปุ่ม **↑ / ↓** ขนาด 44px เพื่อจัดลำดับ เลื่อนรายการด้วยนิ้วได้ตามปกติ ไม่ต้องกดค้างเพื่อลาก

## มือถือ: เลย์เอาต์ + ข้อความไม่ล้น (v1.2.1)

- หน้า Extensions จริงบนมือถือสแตกเป็นแถวเดียว ตัวจัดเรียงรวมเมนูเป็นรายการเดียว
...
รัน `node test.mjs` เพื่อตรวจลำดับ การแยกโปรไฟล์ การซ่อน และการรักษาค่าของ extension ที่ยังโหลดไม่เสร็จ
